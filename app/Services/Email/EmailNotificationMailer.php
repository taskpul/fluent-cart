...
class EmailNotificationMailer
{
    ...
    public function getEmailFooter(): string
    {
        ...
        if (!App::isProActive() || $isEmailFooter === 'yes') {
            $cartFooter = "<div style='padding: 15px; text-align: center; font-size: 16px; color: #2F3448;'>Powered by <a href='https://mattercall.com' style='color: #017EF3; text-decoration: none;'>MatterCall Inc</a></div>";
            $footer .= $cartFooter;
        }
        return $footer;
