...
const chartType = ref(
  ChartTypeFilter.getChartType("subscription", "churn_chart") || "line"
);
...
const toggleChartType = (type) => {
  ChartTypeFilter.onChange("subscription", "churn_chart", type);
